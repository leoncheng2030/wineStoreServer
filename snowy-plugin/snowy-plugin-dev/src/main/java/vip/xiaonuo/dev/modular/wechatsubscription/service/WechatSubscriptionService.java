 ...
 */
package vip.xiaonuo.dev.modular.wechatsubscription.service;
...
public interface WechatSubscriptionService {
     ...
     * 发送订阅消息
     *
     * @param wechatSubscriptionSendParam 发送参数
     * @return 发送结果
     */
    String sendSubscriptionMessage(WechatSubscriptionSendParam wechatSubscriptionSendParam);
     ...
     * @return 操作结果
     */
    boolean decreaseSubscriptionCount(String openid, String templateId);
}