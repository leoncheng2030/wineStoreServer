...
public class SysLoginUserApiProvider implements SaBaseLoginUserApi {
    ...
    @Override
    public SaBaseClientLoginUser getUserByOpenId(String openid) {
        return null;
    }

    @Override
    public SaBaseClientLoginUser createUserWithOpenId(String openid, String nickName, String avatarUrl, String s, String unionid, String phoneNumber) {
        return null;
    }
}
