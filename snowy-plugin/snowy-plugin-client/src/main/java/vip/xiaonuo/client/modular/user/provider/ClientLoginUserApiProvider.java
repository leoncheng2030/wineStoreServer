...
public class ClientLoginUserApiProvider implements SaBaseLoginUserApi {
    ...
    @Override
    public ClientLoginUser getUserByOpenId(String openid) {
        return clientUserService.getByOpenid(openid);
    }
    @Override
    public ClientLoginUser createUserWithOpenId(String account, String nickName, String avatarUrl, String openid, String unionid, String phoneNumber) {
        ClientUser clientUser = clientUserService.createUserWithOpenId(account, nickName, avatarUrl, openid, unionid, phoneNumber);
