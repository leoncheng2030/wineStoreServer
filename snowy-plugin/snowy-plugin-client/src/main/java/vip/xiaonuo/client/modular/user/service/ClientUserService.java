...
public interface ClientUserService extends IService<ClientUser> {
     ...
     * @date [Current Date]
     */
    List<ClientUser> listByIds(ClientUserIdListParam idList);
     ...
     * @date 2022/8/25 15:16
     **/
    ClientLoginUser getByOpenid(String openid);
    /**
     * 根据openid创建用户
     *
     * @author xuyuxiang
     * @date 2022/8/25 15:16
     **/
    ClientUser createUserWithOpenId(String account, String nickName, String avatarUrl, String openId, String unionid, String phoneNumber);
     ...
     * @date 2022/8/25 15:16
     **/
    void cancelUserAgent(String userId);

    List<ClientUser> listByIds(String[] userIds);
}
