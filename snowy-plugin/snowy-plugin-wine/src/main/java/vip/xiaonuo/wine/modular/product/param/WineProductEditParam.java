...
public class WineProductEditParam {
    ...
    /** 酒品分类 */
    @ExcelProperty("酒品分类")
    @Schema(description = "酒品分类", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "productType不能为空")
    private String productType;

    /** 酒精度数 */
    @ExcelProperty("酒精度数")
    @Schema(description = "酒精度数", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "alcoholContent不能为空")
    ...
    /** 零售单价 */
    @ExcelProperty("零售单价")
    @Schema(description = "零售单价", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "unitPrice不能为空")
    private BigDecimal unitPrice;

    /** 酒品图片URL */
    @ExcelProperty("酒品图片URL")
    @Schema(description = "酒品图片URL", requiredMode = Schema.RequiredMode.REQUIRED)
