	...
	<a-spin :spinning="loadSpinning">
		...
		>
			...
			<a-form-item label="支付服务URL：" name="SNOWY_PAY_ALI_SERVER_URL">
				<a-input v-model:value="formData.SNOWY_PAY_ALI_SERVER_URL" placeholder="请输入支付服务地址" />
			</a-form-item>
			<a-form-item label="支付宝支付商家用户ID：" name="SNOWY_PAY_ALI_MCH_USER_ID">
				<a-input v-model:value="formData.SNOWY_PAY_ALI_MCH_USER_ID" placeholder="请输入支付宝支付商家用户ID" />
			</a-form-item>
			<a-form-item label="支付宝支付回调地址：" name="SNOWY_PAY_ALI_NOTIFY_URL">
				<a-input v-model:value="formData.SNOWY_PAY_ALI_NOTIFY_URL" placeholder="请输入支付宝支付回调地址" />
			</a-form-item>
			<a-form-item>
...
const formRules = {
	...
	SNOWY_PAY_ALI_SERVER_URL: [required('请输入支付宝支付网关地址')],
	SNOWY_PAY_ALI_MCH_USER_ID: [required('请输入支付宝支付商家用户ID')],
	SNOWY_PAY_ALI_NOTIFY_URL: [required('请输入支付宝支付回调地址')]
}
// 验证并提交数据
const onSubmit = () => {
