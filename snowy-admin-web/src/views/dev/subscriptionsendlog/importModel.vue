...
<script setup name="wechatSubscriptionSendLogImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wechatSubscriptionSendLogApi
			.wechatSubscriptionSendLogImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wechatSubscriptionSendLogApi.wechatSubscriptionSendLogDownloadTemplate().then((res) => {
