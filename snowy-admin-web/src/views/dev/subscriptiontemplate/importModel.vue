...
<script setup name="wechatSubscriptionTemplateImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wechatSubscriptionTemplateApi
			.wechatSubscriptionTemplateImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wechatSubscriptionTemplateApi.wechatSubscriptionTemplateDownloadTemplate().then((res) => {
