...
<script setup name="wineDeviceRoleImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wineDeviceRoleApi
			.wineDeviceRoleImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wineDeviceRoleApi.wineDeviceRoleDownloadTemplate().then((res) => {
