...
<script setup name="wineAccountFlowImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wineAccountFlowApi
			.wineAccountFlowImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wineAccountFlowApi.wineAccountFlowDownloadTemplate().then((res) => {
