...
<script setup name="wineCommissionRecordImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wineCommissionRecordApi
			.wineCommissionRecordImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wineCommissionRecordApi.wineCommissionRecordDownloadTemplate().then((res) => {
