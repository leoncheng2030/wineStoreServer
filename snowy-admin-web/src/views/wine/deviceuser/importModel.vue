...
<script setup name="wineDeviceUserImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wineDeviceUserApi
			.wineDeviceUserImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wineDeviceUserApi.wineDeviceUserDownloadTemplate().then((res) => {
