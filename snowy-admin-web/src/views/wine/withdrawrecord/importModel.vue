...
<script setup name="wineWithdrawRecordImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wineWithdrawRecordApi
			.wineWithdrawRecordImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wineWithdrawRecordApi.wineWithdrawRecordDownloadTemplate().then((res) => {
