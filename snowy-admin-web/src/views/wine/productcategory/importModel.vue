...
<script setup name="wineProductCategoryImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wineProductCategoryApi
			.wineProductCategoryImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wineProductCategoryApi.wineProductCategoryDownloadTemplate().then((res) => {
