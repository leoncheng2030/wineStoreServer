...
<script setup name="wineUserAccountImportModel">
	...
	const customRequestLocal = (data) => {
		...
		return wineUserAccountApi
			.wineUserAccountImport(fileData)
			.then((res) => {
	...
	const downloadImportTemplate = () => {
		wineUserAccountApi.wineUserAccountDownloadTemplate().then((res) => {
