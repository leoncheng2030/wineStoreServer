...
// 获取API地址，优先使用动态配置，其次使用环境变量
const getApiUrl = () => {
  if (typeof window !== 'undefined' && window.SNOWY_CONFIG && window.SNOWY_CONFIG.VITE_API_BASEURL) {
    return window.SNOWY_CONFIG.VITE_API_BASEURL;
  }
