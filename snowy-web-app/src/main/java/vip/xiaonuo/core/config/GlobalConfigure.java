...
public class GlobalConfigure implements WebMvcConfigurer {
    ...
    public static final String[] NO_LOGIN_PATH_ARR = {
            ...
            "/mini/store/detail",
            "/pay/wx/notifyUrl",
            "/pay/wx/refundNotifyUrl",
            "/pay/wx/transferNotifyUrl",
            "/mini/base/config",
            "mini/device/detailByCode",
            "/wine/device/createQrCode",
            "/pay/wx/testAddProfitSharingReceiver",
            "/ws/realtime"
    };
    ...
    private static final String[] CLIENT_USER_PERMISSION_PATH_ARR = {
            ...
            "/pay/wx/**",
            "/device-manager/**",
            "/client/clientAccount/updateUserInfo",
    };
