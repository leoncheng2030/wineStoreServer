...
public interface SaBaseLoginUserApi {
    ...
    /**
     * 根据openid获取C端用户信息，查不到则返回null
     *
     * @author xuyuxiang
     * @date 2022/3/10 16:14
     **/
    SaBaseClientLoginUser getUserByOpenId(String openid);
    /**
     * 使用openid创建C端用户
     *
     * @author xuyuxiang
     * @date 2022/3/10 16:14
     **/
    SaBaseClientLoginUser createUserWithOpenId(String account, String nickName, String avatarUrl, String openId, String unionid, String phoneNumber);
}
